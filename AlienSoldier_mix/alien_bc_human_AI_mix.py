...
def main():
    ...
    while True:
        ...
        if key.Q in key_state: #rightモデルによる操作
            ...
            judge = 3
            countE +=1
        elif key.R in key_state: # 人による操作
            judge = 4
            countHuman +=1
        ...
        if done:
            active += 1
            print('reward,', total_reward, ', action,',count0,',',count1,',',count2,',',count3,',',count4,',',count5,',',count6,', QWER',countQ,',',countW,',',countE,',',countHuman,', count=',active)
            count0 = 0
            count1 = 0
            count2 = 0
            count3 = 0
